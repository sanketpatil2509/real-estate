<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminagent.aspx.cs" Inherits="Resposive_Website.EstateAgency.EstateAgency.adminagent" %>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <h1 style="margin:10px; padding:10px">Agent Details</h1>
                        <div class="card-body">
                            <table id="datatablesSimple" style="width:100%;margin:20px; border:solid"class="table table-bordered">
                                ...
                                <asp:Repeater ID="agentdetailsid" runat="server">
                                    <ItemTemplate>
