...
namespace Resposive_Website.EstateAgency.EstateAgency
{
    public partial class demo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DBWEBConnectionString"].ConnectionString);
                SqlCommand cmd = new SqlCommand("savedatatoadmin", con);
                cmd.CommandType = CommandType.StoredProcedure;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                con.Open();
                sda.Fill(ds);
                rptsaledetails.DataSource = ds;
                rptsaledetails.DataBind();
                con.Close();
            }
        ...
        protected void LinkButton1_Click1(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("deletesaledetails", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DBWEBConnectionString"].ConnectionString);
            SqlCommand cmd = new SqlCommand("filterrecordsbyemail", con);
            cmd.CommandType = CommandType.StoredProcedure;
