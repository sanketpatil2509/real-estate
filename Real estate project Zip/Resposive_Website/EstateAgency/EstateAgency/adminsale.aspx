<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminsale.aspx.cs" Inherits="Resposive_Website.EstateAgency.EstateAgency.demo" %>
...
<body class="sb-nav-fixed">
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                         ...
                         <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                          ...
                          <a class="nav-link" href="admincontact.aspx">Contact</a>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card bg-warning text-white mb-4">
            <div class="card-body">Total Rent
                <div >
        ...
        <div class="card bg-danger text-white mb-4">
            ...
            <div class="card-footer d-flex align-items-center justify-content-between">
                ...
                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                    ...
                    <%--<div class="card mb-12" style="width:auto">--%>
                        <%--<div class="card-header" >
                            <i class="fas fa-table me-1"></i>
                            Sale Details
                        
                        <div class="card-body">--%><hr />
                <h1 style="margin:10px; padding:10px">Sale Details</h1>
                <div class="card-body" style="margin-left:40px">
                        <asp:TextBox ID="txtsearch" runat="server" Width="250px" BorderStyle="Groove"></asp:TextBox>
                            <asp:Button ID="Button1" runat="server" Text="Search" OnClick="Button1_Click" BorderStyle="Groove" /></div>
                ...
                <asp:Repeater ID="rptsaledetails" runat="server" >
                            <ItemTemplate>
                            <tbody style="background-color:lightcyan">
                                <tr>
                                     ...
                                     <td><%#Eval("Pan_No") %></td>
                                     <td><%#Eval("DOB") %></td>
                                     <td><%#Eval("Permanent_Add") %></td>
                                     <td><%#Eval("Correspond_Add") %></td>
                                     <td><%#Eval("Country") %></td>
                                     <td><%#Eval("City") %></td>
                                     <td><%#Eval("RCDate") %></td>
                                     <td><%#Eval("KYC_file_Path") %></td>
                                     <td><%#Eval("Bank_Name") %></td>
                                     <td><%#Eval("Transaction_Id") %></td>
                                     <td><%#Eval("Agent_Id") %></td>
                                     <td><%#Eval("Sale_Amount") %></td>
                                    <td>
                                    ...
                                    <td><a href="saleedit.aspx?id=<%#Eval("Id") %>">Edit</a></td>
                                </tr>
                            </tbody>
                                </ItemTemplate>
                            </asp:Repeater>
