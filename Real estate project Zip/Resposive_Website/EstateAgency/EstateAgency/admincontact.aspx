<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admincontact.aspx.cs" Inherits="Resposive_Website.EstateAgency.EstateAgency.admincontact" %>
        ...
        <div class="card bg-danger text-white mb-4">
            ...
            <div class="card-footer d-flex align-items-center justify-content-between">
                ...
                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                   ...
                   <h1 style="margin:10px; padding:10px">Contact Details:</h1>
                        ...
                        <div class="card-body">
                             <table id="datatablesSimple" style="width:100%;margin:20px; border:solid" class="table table-bordered">
                                ...
                                <asp:Repeater ID="contactrecordid" runat="server">
                                    <ItemTemplate>
