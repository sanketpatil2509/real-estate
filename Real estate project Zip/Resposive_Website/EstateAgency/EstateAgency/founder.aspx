<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="founder.aspx.cs" Inherits="Resposive_Website.EstateAgency.EstateAgency.about" %>
...
<head>
  ...
  <title>About - Bold Real Estate</title>
...
<body class="about-page">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
         ...
         <li class="dropdown"><a href="#"><span>About</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
               <ul>
                  <li><a href="about.aspx" class="active">About Bold Real Estate</a></li>
  ...
  <main class="main">
    ...
    <div class="page-title" data-aos="fade">
      <div class="heading" style="background-image:url('assets/img/aboutimg.jpg'); height:350px" >
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1 style="color:blueviolet">Founders</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-12 content" data-aos="fade-up" data-aos-delay="100">
            ...
            <p class="who-we-are"><strong>The storied journey of Bold-Real Estate Developers Limited started with Mr. Aniruddha Patil, our visionary Founder setting up real estate business in Pune,
                Maharashtra in the year 1985. Mr. Aniruddha Patil, fondly referred to as AVP by Bold-Real-Patilites started the real estate development business in Pune with a vision to offer plotting development,
                row houses, and bungalows to home buyers at value pricing with an emphasis on quality.
                </strong></p>
            <p style="color:orange">
                Mr. Rajesh Patil, Chairman and Managing Director</p>
              <p>
              ...
              <p style="color:orange">
                  Mr. Naresh Patil, Vice-Chairman</p>
                <p>Mr. Naresh Patil holds a degree in Commerce from University of Pune. He has more than 30 years of experience in real estate development including company level strategy,
