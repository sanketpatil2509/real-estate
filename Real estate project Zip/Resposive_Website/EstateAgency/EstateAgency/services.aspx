<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="services.aspx.cs" Inherits="Resposive_Website.EstateAgency.EstateAgency.services" %>
...
<head>
  ...
  <title>Services - Bold Real Estate </title>
...
<body class="services-page">
  ...
  <main class="main">
    <%--<img src="assets/img/back3img.jpg" />--%>
      ...
      <div class="heading" style="background-image:url('assets/img/back10.jpg');">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1 style="color:blueviolet">Services</h1>
              <b><p class="mb-0">If you want to network with real estate professionals at almost no cost, then joining forums is the easiest way. From marketing tips and business strategies to investment-related questions, you can post multiple articles on forums.</p> </b>           </div>
          </div>
    <%--<img src="assets/img/back9.jpg" />--%>
        </div>
      </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              ...
              <p>Industry-leading methodologics for accurate results</p>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <p>Tailored services based on your needs and business goals</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item position-relative">
              ...
              <p>Clear insignhts for informed decision making</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <a href="" class="stretched-link">
                <h3>Buying or Selling a Mixed Use Property</h3>
              </a>
              <p>Our sector-specific teams come together to provide a seamless range of servic.es across mix use projects</p>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="service-item position-relative">
              <div class="icon">
                <i class="bi fa-person-biking"></i>
              </div>
              <a href="" class="stretched-link">
                <h3>Master Planning</h3>
              </a>
              <p>Planning requires a meticulous approach to understanding local market conditions as well the latest town planning policies and procedures.</p>
              <a href="" class="stretched-link"></a>
            </div>
          </div><!-- End Service Item -->
