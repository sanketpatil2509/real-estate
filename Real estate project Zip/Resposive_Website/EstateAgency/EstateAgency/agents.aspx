<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agents.aspx.cs" Inherits="Resposive_Website.EstateAgency.EstateAgency.agents" %>
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="agents.aspx" class="active">Agents</a></li>
      ...
      <div class="heading" style="background-image:url('assets/img/back10.jpg');">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1 style="color:blueviolet">Agents</h1>
              <b><p class="mb-0">In addition to publishing social media posts with client testimonials, you may also use them as strong website features. This is a step that normally helps to build trust with your potential clients and to show that you have the potential to provide real estate services in a professional way.</p></b>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              <div class="pic"><img src="assets/img/team/agent1.jpg" class="img-fluid" alt="" style="border:double"></div>
              <div class="member-info">
                  <b><asp:Label ID="agent1" runat="server"></asp:Label></b>
                <span>Agent</span>
                <div class="social">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <div class="pic"><img src="assets/img/team/agent2.jpg" class="img-fluid" alt="" style="border:double"></div>
              <div class="member-info">
                 <b><asp:Label ID="agent2" runat="server"></asp:Label></b>
                <span>Agent</span>
                <div class="social">
                  <a href=""><i class="bi bi-twitter-x"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="member"> 
              <div class="pic"><img src="assets/img/team/agent3.jpg" class="img-fluid" alt="" style="border:double"></div>
              <div class="member-info">
                  <b><asp:Label ID="agent3" runat="server"></asp:Label></b>
                <span>Agent<br></span>
                <div class="social">
                  <a href=""><i class="bi bi-twitter-x"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
