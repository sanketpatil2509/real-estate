<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="property-single.aspx.cs" Inherits="Resposive_Website.EstateAgency.EstateAgency.property_single" %>
...
<head>
  ...
  <title>Property Single - Bold Real Estate</title>
        ...
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              ...
              <p class="mb-0">Renters also need to know when the property is available and what lease terms the landlord will accept. Make this language as simple as possible so there is no room for misunderstandings.</p>            </div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-3" data-aos="fade-up" data-aos-delay="100">
            <div class="portfolio-info">
              <h3>Quick Summary</h3>
              <ul>
                <li><strong>Property ID:</strong>India </li>
                <li><strong>Location:</strong>204,ShivajiNagar, Pune</li>
                <li><strong>Property Type:</strong> House</li>
                <li><strong>Status:</strong> Sale</li>
                <li><strong>Area:</strong> <span>1200SqFt <sup>2</sup></span></li>
