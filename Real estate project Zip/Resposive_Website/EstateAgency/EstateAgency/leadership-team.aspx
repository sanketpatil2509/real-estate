<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="leadership-team.aspx.cs" Inherits="Resposive_Website.EstateAgency.EstateAgency.leadership_team" %>
      ...
      <ul>
        ...
        <li class="dropdown"><a href="#"><span>About</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
           <ul>
              ...
              <li><a href="leadership-team.aspx" class="active">LeaderShip Team</a></li>
       ...
       <div class="container" >
         <div class="row d-flex justify-content-center text-center">
           <div class="col-lg-10" style="text-align:center" >
            ...
            <h5> <p class="who-we-are""><b><pre style="font-family:'Times New Roman', Times, serif">
                 We believe human capital growth is what enablestop quartile performance for an organisation and
                  at Bold Real Estate we believe in onboarding,developing and retaining the best talent. We have
                  nurtured a zero bureaucracy culture that maintains a fine balance between individual  aspirations
                 and teamwork.The Company empowers its leaders which enables them to respond like entrepreneurs.
                  
    </b></pre></p></h5>
               <h5>Below list captures leaders who are driving growth at Bold Real Estate Developers:</h5>
        </div>
             <p style="color:orange">Mr.Tushar Patil</p>
             <p><b>Group CEO</b></p>
             <p style="color:orange">Mr.Dhruv Jamdade</p>
     ...
     <div class="container">
       ...
       <div class="row gy-4">
         ...
         <div class="col-lg-12 content" data-aos="fade-up" data-aos-delay="100">
           ...
           <p class="who-we-are"><strong>We believe human capital growth is what enables top quartile performance for an organisation and at Kolte-Patil we believe in onboarding, developing and retaining the best talent. We have nurtured a zero bureaucracy culture that maintains a fine balance between individual aspirations and teamwork. The Company empowers its leaders which enables them to respond like entrepreneurs.
